"""
MCP tool for Clubhouse uses this to check for updates when app is not installed from App Store (eg TestFlight)
"""
...
def get_check_for_update(is_testflight: str) -> str:
    """
